...
import iconNav from 'vue-ionicons/dist/md-menu.vue'
Vue.component('icon-nav', iconNav)
...
import iconLogout from 'vue-ionicons/dist/md-log-out.vue'
Vue.component('icon-logout', iconLogout)
import iconLogin from 'vue-ionicons/dist/md-log-in.vue'
