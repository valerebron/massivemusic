<template>
  <div class="home">
    {{ currentState }}
    <youtube ytid="T4R6iFSYDZ0" ref="yt" :playerVars="playerVars" @ready="playerReady" @state-change="updatePlayerState" @playback-rate-change="apiChange"></youtube>
    ...
    <progress :value="currentVolume" max="100"></progress>
