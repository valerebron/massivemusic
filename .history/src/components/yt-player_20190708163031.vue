...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      playPrev() {
        let currentTrack = document.querySelectorAll('[data-id="'+this.currentYtid+'"]')
        console.log(currentTrack.previousSibling.length)
        if(typeof currentTrack.previousSibling === 1) {
