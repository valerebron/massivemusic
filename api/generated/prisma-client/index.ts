...
export interface Exists {
  ...
  test4: (where?: Test4WhereInput) => Promise<boolean>;
...
export interface Prisma {
  ...
  test4: (where: Test4WhereUniqueInput) => Test4NullablePromise;
  test4s: (args?: {
    where?: Test4WhereInput;
    orderBy?: Test4OrderByInput;
    skip?: Int;
    after?: String;
    before?: String;
    first?: Int;
    last?: Int;
  }) => FragmentableArray<Test4>;
  test4sConnection: (args?: {
    where?: Test4WhereInput;
    orderBy?: Test4OrderByInput;
    skip?: Int;
    after?: String;
  ...
  createTest4: (data: Test4CreateInput) => Test4Promise;
  deleteTest4: (where: Test4WhereUniqueInput) => Test4Promise;
  deleteManyTest4s: (where?: Test4WhereInput) => BatchPayloadPromise;
...
export interface Subscription {
  ...
  test4: (
    where?: Test4SubscriptionWhereInput
  ) => Test4SubscriptionPayloadSubscription;
  track: (
...
export type Test4OrderByInput = "id_ASC" | "id_DESC";
...
export type Test4WhereUniqueInput = AtLeastOne<{
  id: Maybe<ID_Input>;
}>;
...
export interface Test4CreateInput {
  id?: Maybe<ID_Input>;
}
...
export interface Test4WhereInput {
  id?: Maybe<ID_Input>;
  id_not?: Maybe<ID_Input>;
  id_in?: Maybe<ID_Input[] | ID_Input>;
  id_not_in?: Maybe<ID_Input[] | ID_Input>;
  ...
  id_ends_with?: Maybe<ID_Input>;
  id_not_ends_with?: Maybe<ID_Input>;
  AND?: Maybe<Test4WhereInput[] | Test4WhereInput>;
  OR?: Maybe<Test4WhereInput[] | Test4WhereInput>;
  NOT?: Maybe<Test4WhereInput[] | Test4WhereInput>;
}
...
export interface Test4SubscriptionWhereInput {
  mutation_in?: Maybe<MutationType[] | MutationType>;
  updatedFields_contains?: Maybe<String>;
  updatedFields_contains_every?: Maybe<String[] | String>;
  updatedFields_contains_some?: Maybe<String[] | String>;
  node?: Maybe<Test4WhereInput>;
  AND?: Maybe<Test4SubscriptionWhereInput[] | Test4SubscriptionWhereInput>;
  OR?: Maybe<Test4SubscriptionWhereInput[] | Test4SubscriptionWhereInput>;
  NOT?: Maybe<Test4SubscriptionWhereInput[] | Test4SubscriptionWhereInput>;
}
...
export interface AggregateTest4 {
  count: Int;
}

export interface AggregateTest4Promise
  extends Promise<AggregateTest4>,
    Fragmentable {
  count: () => Promise<Int>;
}

export interface AggregateTest4Subscription
  extends Promise<AsyncIterator<AggregateTest4>>,
    Fragmentable {
  count: () => Promise<AsyncIterator<Int>>;
}
...
export interface Test4Connection {
  pageInfo: PageInfo;
  edges: Test4Edge[];
}

export interface Test4ConnectionPromise
  extends Promise<Test4Connection>,
    Fragmentable {
  pageInfo: <T = PageInfoPromise>() => T;
  edges: <T = FragmentableArray<Test4Edge>>() => T;
  aggregate: <T = AggregateTest4Promise>() => T;
}

export interface Test4ConnectionSubscription
  extends Promise<AsyncIterator<Test4Connection>>,
    Fragmentable {
  pageInfo: <T = PageInfoSubscription>() => T;
  edges: <T = Promise<AsyncIterator<Test4EdgeSubscription>>>() => T;
  aggregate: <T = AggregateTest4Subscription>() => T;
}
...
export interface Test4PreviousValues {
  id: ID_Output;
}

export interface Test4PreviousValuesPromise
  extends Promise<Test4PreviousValues>,
    Fragmentable {
  id: () => Promise<ID_Output>;
}

export interface Test4PreviousValuesSubscription
  extends Promise<AsyncIterator<Test4PreviousValues>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
}

export interface Test4SubscriptionPayload {
  mutation: MutationType;
  node: Test4;
  updatedFields: String[];
  previousValues: Test4PreviousValues;
}

export interface Test4SubscriptionPayloadPromise
  extends Promise<Test4SubscriptionPayload>,
    Fragmentable {
  mutation: () => Promise<MutationType>;
  node: <T = Test4Promise>() => T;
  updatedFields: () => Promise<String[]>;
  previousValues: <T = Test4PreviousValuesPromise>() => T;
}

export interface Test4SubscriptionPayloadSubscription
  extends Promise<AsyncIterator<Test4SubscriptionPayload>>,
    Fragmentable {
  mutation: () => Promise<AsyncIterator<MutationType>>;
  node: <T = Test4Subscription>() => T;
  updatedFields: () => Promise<AsyncIterator<String[]>>;
  previousValues: <T = Test4PreviousValuesSubscription>() => T;
}
...
export interface Test4Promise extends Promise<Test4>, Fragmentable {
  id: () => Promise<ID_Output>;
}

export interface Test4Subscription
  extends Promise<AsyncIterator<Test4>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
}

export interface Test4NullablePromise
  extends Promise<Test4 | null>,
    Fragmentable {
  id: () => Promise<ID_Output>;
}

export interface Test4Edge {
  node: Test4;
  cursor: String;
}

export interface Test4EdgePromise extends Promise<Test4Edge>, Fragmentable {
  node: <T = Test4Promise>() => T;
  cursor: () => Promise<String>;
}

export interface Test4EdgeSubscription
  extends Promise<AsyncIterator<Test4Edge>>,
    Fragmentable {
  node: <T = Test4Subscription>() => T;
  cursor: () => Promise<AsyncIterator<String>>;
}
