...
type Mutation {
  ...
  createTest4(data: Test4CreateInput!): Test4!
  deleteTest4(where: Test4WhereUniqueInput!): Test4
  deleteManyTest4s(where: Test4WhereInput): BatchPayload!
...
type Query {
  ...
  test4s(where: Test4WhereInput, orderBy: Test4OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Test4]!
  test4sConnection(where: Test4WhereInput, orderBy: Test4OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): Test4Connection!
...
type Subscription {
  ...
  test4(where: Test4SubscriptionWhereInput): Test4SubscriptionPayload
...
type Test4Connection {
  pageInfo: PageInfo!
  edges: [Test4Edge]!
  aggregate: AggregateTest4!
}
...
enum Test4OrderByInput {
  id_ASC
  id_DESC
}

type Test4PreviousValues {
  id: ID!
}

type Test4SubscriptionPayload {
  mutation: MutationType!
  node: Test4
  updatedFields: [String!]
...
input Test4SubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: Test4WhereInput
  AND: [Test4SubscriptionWhereInput!]
  OR: [Test4SubscriptionWhereInput!]
  NOT: [Test4SubscriptionWhereInput!]
}
