...
// Returns the private 'App\Repository\StyleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StyleRepository.php';

return $this->privates['App\\Repository\\StyleRepository'] = new \App\Repository\StyleRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
