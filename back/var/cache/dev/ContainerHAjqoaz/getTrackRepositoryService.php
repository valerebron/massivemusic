...
// Returns the private 'App\Repository\TrackRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TrackRepository.php';

return $this->privates['App\\Repository\\TrackRepository'] = new \App\Repository\TrackRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
