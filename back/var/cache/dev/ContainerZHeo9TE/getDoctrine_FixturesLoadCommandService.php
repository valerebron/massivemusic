...
include_once $this->targetDirs[3].'\\src\\DataFixtures\\MemberFixtures.php';
include_once $this->targetDirs[3].'\\src\\DataFixtures\\StyleFixtures.php';
include_once $this->targetDirs[3].'\\src\\DataFixtures\\TrackFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\MemberFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\StyleFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\TrackFixtures(), 'groups' => []]]);

$this->privates['doctrine.fixtures_load_command'] = $instance = new \Doctrine\Bundle\FixturesBundle\Command\LoadDataFixturesDoctrineCommand($a, ($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
