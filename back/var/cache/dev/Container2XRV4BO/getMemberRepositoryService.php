...
// Returns the private 'App\Repository\MemberRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MemberRepository.php';

return $this->privates['App\\Repository\\MemberRepository'] = new \App\Repository\MemberRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')));
